  ...
  return (
    <div className="slider">
      <div
        className={
        toggle
        ? "flex gap-6 w-full overflow-y-hidden webkit pers select-none relative will-change-transform cursor-pointer transition-all duration-[0.2s] scale-95"
        : "flex gap-6 active w-full overflow-y-hidden webkit pers select-none relati will-change-transform cursor-pointer transition-all duration-[0.2s] scale-100"
        }
      >
